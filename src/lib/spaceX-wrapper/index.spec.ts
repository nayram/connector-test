    ...
    describe('getRocketById', () => {
        describe('success', () => { 
            ...
            beforeEach(async () => {
                ...
                spacexScope = getRocketMockRequest(rocketId, statusCode, mockResponseData)
            })
        ...
        describe('failure', () => { 
            it('should throw an error if the api call fails', () => {
                ...
                return expect(getRocketById(rocketId)).rejects.toThrowError('Request failed with status code 500')
            })
         })
    })
})
